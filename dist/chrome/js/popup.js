...
document.addEventListener("DOMContentLoaded", () => {
    ...
    saveButton.addEventListener("click", () => {
        ...
        chrome.storage.sync.set({ "hostURL": hostURL, "token": token, "directory": directory, "appendPageTitleDefault": appendPageTitleDefault }, () => {
            hideConfigure();
            showCapture();
...
function showConfigure() {
    ...
    chrome.storage.sync.get(["hostURL", "token", "directory", "appendPageTitleDefault"], (items) => {
